...
CLASS UTILITY
{
	...
	//Get all directory type
	function get_all_dir_type()
	{
		$branch_str = "Dubai,Abu Dhabi,24/7 Hotline,Sales,Dell Support,PMS Support,Interface Support,POS Support,Enterprise Support,Service Center,Delivery,Showroom";
        $branches = explode(',',$branch_str);
        return $branches;
	}
